...
fun SettingsScreen(
    ...
    Column(
        ...
        SettingCard(
            ...
            enabled = isAppEnabled == true // Enable if app is enabled
        )
        ...
        TextField(
            ...
            maxLines = 5,
            enabled = isAppEnabled == true && !drivingModeEnabled, // Enabled only if app is enabled AND driving mode switch is OFF
